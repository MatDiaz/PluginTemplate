...
{
public:
	FilmStripKnob(Image image, const int numFrames, const bool stripIsHorizontal) // Class Constructor
...
void paint(Graphics& g) // Override the paint method from the Slider Class
{   
...
private:
	...
	Image filmStrip; // Create Image Object (with Filmstrip)
